...
export const createCollectionRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function createCollection(dcOrVars, vars) {
  return executeMutation(createCollectionRef(dcOrVars, vars));
}

export const listCollectionsRef = (dc) => {
  const { dc: dcInstance} = validateArgs(connectorConfig, dc, undefined);
  dcInstance._useGeneratedSdk();
...
export function listCollections(dc) {
